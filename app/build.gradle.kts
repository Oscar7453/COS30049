...
dependencies {
    ...
    implementation("com.facebook.react:react-native-gesture-handler:+")
    implementation("com.facebook.react:react-native-screens:+")
    implementation("com.facebook.react:react-native-safe-area-context:+")
}
